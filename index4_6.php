...
<div id="page-content-wrapper">
  ...
  <table class="table shadow" name="t1" style="width: 100%;">		
                                          ...
                                          <tr>
                                              ...
                                              <th width="11%"> <center><a>ชื่อ-สกุล</th></a> </center>
                                              <th width="13%"> <center><a>ประเภทผู้ใช้บริการ</th></a> </center>
                                              <th width="18%"> <center><a>คณะ/หน่วยงาน</th></a> </center>
                                              <th width="12%"> <center><a>วัน/เดือน/ปี ที่ซ่อมเสร็จ</th></a> </center>
                                              <th width="10%"> <center><a>ผู้ซ่อม</th></a> </center>
                                              <th width="10%"> <center><a>ผลการซ่อม</th></a> </center>
                                              <th width="12%"> <center><a>รายละเอียด</th></a> </center>
                                          </tr>
                                   
                                          <tbody>
										<?php include("connectdb.php");
									$sql = "SELECT * FROM `success` where day = '".$_POST['day']."' or month = '".$_POST['moth']."' 
									and year = '".$_POST['year']."' ORDER BY `success`.`s_id` DESC";
									...
									?>
                                        <tr>
											...
											<td><span class="text-danger"><center><a><?php echo $data['result'] ?></span></td></a> </center>
