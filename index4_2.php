...
<?php }
  ...
  <path d="M1 0L0 1l2.2 3.081a1 1 0 0 0 .815.419h.07a1 1 0 0 1 .708.293l2.675 2.675-2.617 2.654A3.003 3.003 0 0 0 0 13a3 3 0 1 0 5.878-.851l2.654-2.617.968.968-.305.914a1 1 0 0 0 .242 1.023l3.356 3.356a1 1 0 0 0 1.414 0l1.586-1.586a1 1 0 0 0 0-1.414l-3.356-3.356a1 1 0 0 0-1.023-.242L10.5 9.5l-.96-.96 2.68-2.643A3.005 3.005 0 0 0 16 3c0-.269-.035-.53-.102-.777l-2.14 2.141L12 4l-.364-1.757L13.777.102a3 3 0 0 0-3.675 3.68L7.462 6.46 4.793 3.793a1 1 0 0 1-.293-.707v-.071a1 1 0 0 0-.419-.814L1 0zm9.646 10.646a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708zM3 11l.471.242.529.026.287.445.445.287.026.529L5 13l-.242.471-.026.529-.445.287-.287.445-.529.026L3 15l-.471-.242L2 14.732l-.287-.445L1.268 14l-.026-.529L1 13l.242-.471.026-.529.445-.287.287-.445.529-.026L3 11z"/>
        ...
        <a href="index4_2.php" class="list-group-item list-group-item-action bg-primary text-white shadow"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
...
<div id="page-content-wrapper">
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom shadow"  style="width: 120%;">
        <button class="btn btn-light shadow" id="menu-toggle"><img src="img/Untitled-1.png" width="30" height="20"></button>
      </nav>
    <br>
    <div class="container-fluid">
        <h2 class="box-title">รายการข้อมูลการซ่อมบำรุงที่ซ่อมเสร็จ</h2>
    <br>      
         
      <form method="post" action="index4_5.php">
  ...
  <br>
  <form method="post" action="index4_6.php">	  
    <div class="row">
      <div class= "col-auto">
  ...
  <div class="container-fluid">
  <meta charset="utf-8">
  <table class="table shadow" name="t1" style="width: 100%;">		
                                     
                                          <tr>
                                              <th width="10%"> <center><a>เลขที่รายการ</th></a> </center>
                                              <th width="12%"> <center><a>ชื่อ-สกุล</th></a> </center>
                                              <th width="14%"> <center><a>ประเภทผู้ใช้บริการ</th></a> </center>
                                              <th width="17%"> <center><a>คณะ/หน่วยงาน</th></a> </center>
                                              <th width="15%"> <center><a>วัน/เดือน/ปี ที่ซ่อมเสร็จ</th></a> </center>
                                              <th width="12%"> <center><a>ผู้ซ่อม</th></a> </center>
                                              <th width="8%"> <center><a>ผลการซ่อม</th></a> </center>
                                              <th width="15%"> <center><a>รายละเอียด</th></a> </center>
                                          </tr>
                                   
    <tbody>
		<?php include("connectdb.php");
		$sql = "SELECT * FROM `success` ORDER BY `success`.`s_id` DESC";
		$rs = mysqli_query($conn,$sql);
		
		while ($data = mysqli_fetch_array($rs)){
    ?>
      <tr>
    <td><center><a><?php echo $data['s_id'] ?></td></a> </center>
    <td class="txt-oflo"><center><a><?php echo $data['name'] ?></td></a> </center>
    <td><center><a><?php echo $data['type'] ?></td></a> </center>
		<td><center><a><?php echo $data['dep'] ?></td></a> </center>
    <td><center><a><?php echo $data['day'],"/",$data['month'],"/",$data['year'] ?></td></a> </center>
		<td class="txt-oflo"><center><a><?php echo $data['admin'] ?></td></a> </center>
		<td><span class="text-success"><center><a><?php echo $data['result'] ?></span></td>
		<td class="txt-oflo"><center><a href=show_2.php?s_id=<?=$data['s_id'];?>">แสดงรายละเอียด</a></td></center>
     </tr>
    </tbody>
    <?php } 
      ?>
