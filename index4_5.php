...
<div id="page-content-wrapper">
  ...
  <table class="table shadow" name="t1" style="width: 100%;">		
									...
									$sql = "SELECT * FROM success where name LIKE '%".$_POST['search']."%' ORDER BY `success`.`s_id` DESC";
