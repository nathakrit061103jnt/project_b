...
<!-- /#sidebar-wrapper -->
 ...
 <?php include("connectdb.php");
   ...
   $sql = "SELECT * FROM services_requests INNER JOIN department ON services_requests.dep_id=department.dep_id INNER JOIN brand ON services_requests.bid=brand.bid INNER JOIN users_type ON services_requests.ut_id=users_type.ut_id where sr_u_fname_th LIKE '%".$_POST['search']."%' ORDER BY `services_requests`.`sr_id` DESC";		
...
<tr>
  ...
  <td><a href="print.php?sr_id=<?=$data['sr_id'];?>"><img src="img/print.png" width="20" height="20"></a></td>
</tr>
</tbody>
<?php }		
	?>
