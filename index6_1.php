        ...
        <form>
          ...
          <div class="form-row">
              <div class="form-group col-md-6 text-left">
                ...
                <input id="user" name="user" type="text" class="btnSubmit shadow " id="inputName" placeholder="" value="<?php echo $data['username'] ?>">
              </div>

              <div class="form-group col-md-6 text-left">
                <label for="inputPassword4">&nbsp;password</label>
                <input id="pwd" name="pwd" type="text" type="nameeng" class="btnSubmit shadow"  placeholder="" value="<?php echo $data['pwd'] ?>" >
              </div>

      
              <div class="form-group col-md-6 text-left">
                <label for="inputEmail4 ">&nbsp;ชื่อ-สกุล</label>
                <input id="name" name="name" type="name" class="btnSubmit shadow " placeholder="" value="<?php echo $data['name'] ?>">
              </div>
           
            
              <div class="form-group col-md-6 text-left">
                <label for="inputState">&nbsp;สถานะ</label>
                <select type="radio" name="status" id="inputState" class="btnSubmit shadow  " >
...
$sql2 = "UPDATE `admin` SET `username` = '".$_POST['user']."' ,`pwd` = '".$_POST['pwd']."' ,`name` = '".$_POST['name']."' ,`status` = '".$_POST['status']."'  WHERE `admin`.`a_id` ='".$_GET['a_id']."'";
	mysqli_query($conn,$sql2) or die("update ไม่ได้");
