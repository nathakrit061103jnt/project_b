...
if ($item["tid"] = $row["tid"]) {
        ...
        ?>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="email" class="form-control" value="<?=$item["sr_email"];?>"
                                        name="sr_email" required placeholder="กรอก E-mail">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="inputPassword4">เบอร์โทรศัพท์</label>
                                    <input type="text" required class="form-control" value="<?=$item["sr_tel"];?>"
                                        name="sr_tel" placeholder="กรอกเบอร์โทรศัพท์">
                                </div>
                            </div>
                            <div class="form-row">
            ...
            ?>><?=$data['dep_name'];?></option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" required class="form-control" id=""
                                        value="<?=$item["sr_user_position"];?>" name="sr_user_position"
...
if ($data['bid'] == $item['bid']) {
            ...
            ?>><?=$data['bname'];?></option>
                                ...
                                <div class="col-md-6">
                                    <label for="mType">ระบุชนิดเครื่อง</label>
            ...
            ?>><?=$data['mtype_name'];?></option>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" required
                                        value="<?=$item["sr_u_fname_th"];?>" name="sr_Important_data"
                                        placeholder="เช่น Drive D">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputCity">รหัสเข้าเครื่อง</label>
                                    <input type="text" value="<?=$item["sr_u_fname_th"];?>" name="sr_password_machine"
                                        required class="form-control" placeholder="ไม่มีให้ใส่เครื่องหมาย(-)">
                                </div>
...
if ($data['cid'] == $item['cid']) {
            ...
            ?>><?=$data['cname'];?></option>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="inputCity">หมายเลขเครื่อง</label>
                                    <input type="text" required class="form-control"
                                        value="<?=$item["sr_machine_number"];?>" id="" name="sr_machine_number"
                                        placeholder="หมายเลขเครื่องสำหรับเครื่องหน่วยงาน ถ้าไม่มีให้ใส่เครื่องหมาย(-)">
                                </div>

                                <input type="hidden" class="form-control" name="sr_id" value="<?=$sr_id?>">


                            </div>
                            <div align="center">
                                <button type="submit" name="update_C2_tSubmit"
